...
<main class="mt-2 px-6">
    ...
    <div class="flex mt-8 mb-14">
        ...
        <a href="/deleted-tour-management"><span class="cursor-pointer text-center ml-4 bg-red active-management-option management-option px-6 py-2">Deleted</span></a>
    </div>
    <div class="w-full">
        {{-- a full width div with bg-parrot class and Live text with bold in it --}}
        <div class="bg-red text-white text-center text-xl font-bold py-4">
            <span class="text-lg uppercase">Deleted</span>
        </div>
    </div>
