...
<body class="bg-gray-100">
    <div class="w-full flex flex-col wommd:flex-row sm:justify-center sm:items-center">
        <!-- Image Section -->
        <div class="hidden wommd:block wommd:w-[65%]">
            ...
            <div id="imageSlider" class="relative min-h-screen w-full overflow-hidden">
                <!-- Slider Images -->
                <div class="slider-images min-h-screen w-full">
                    <img class="min-h-screen w-full object-cover absolute opacity-0 transition-opacity duration-1000 ease-in-out"
        ...
        <div class="w-full wommd:w-[35%] bg-white shadow-md">
            <div
                class="flex flex-col wommd:justify-start pt-0 short:pt-16 wommd:pt-32 items-center min-h-screen sm:w-full wommd:h-full px-6 py-12">
                <!-- Logo and Header -->
                <div class="flex flex-row justify-center items-center mb-6 px-16">
                    <img class="max-w-[250px] womsm:max-w-[300px] wommd:max-w-[350px]" src="{{ asset('images/logo-text.png') }}"
                ...
                <form method="POST" action="{{ route('register') }}" class="space-y-4">
                    ...
                    <table>
                        ...
                        <tr>
                            <td class="w-[82px]">
                                <label style="text-align: right;" for="name"
                                    class="block text-sm wommd:text-base font-medium text-gray-700 mr-2 mt-5">Name</label>
                            </td>
                            <td class="w-[283px]">
                                <input id="name"
                                    class="w-full mt-5 {{ is_array($errors->get('name')) && !empty($errors->get('name')) ? 'error-input' : '' }} block text-sm wommd:text-base w-full mt-1 border rounded-lg shadow-sm"
                        ...
                        <tr>
                            <td class="w-[82px]">
                                <label style="text-align: right;" for="email"
                                    class="block text-sm wommd:text-base font-medium text-gray-700 mr-2 mt-2">Email</label>
                            </td>
                            <td class="w-[283px]">
                                <input id="email"
                                    class="w-full mt-2 {{ is_array($errors->get('email')) && !empty($errors->get('email')) ? 'error-input' : '' }} block text-sm wommd:text-base w-full mt-1 border rounded-lg shadow-sm"
                        ...
                        <tr>
                            <td colspan="2" class="w-full">
                                <div class="text-center mt-5">
                                    <x-input-error :messages="$errors->get('name')" class="mt-2 text-sm wommd:text-base" />
                                    ...
                                    <x-input-error :messages="$errors->get('terms-conditions')" class="mt-2 text-sm wommd:text-base" />
                                </div>
                            </td>
                        </tr>
                        <tr>
                            <td colspan="2" class="w-full">
                                <div class="text-right mt-5">
                                    ...
                                    <label for="terms-conditions"
                                        class="ml-2 text-sm wommd:text-base text-gray-600 font-medium">
                                        Accept
                                        <a href="#" class="text-green text-sm wommd:text-base font-bold underline">
                                            Terms and Condition
                                        </a>
                                        &
                                        <a href="#" class="text-green text-sm wommd:text-base font-bold underline">
                        ...
                        <tr>
                            <td class="w-[82px]"></td>
                            <td class="w-[283px]">
                                <button style="padding: 12px" class="mt-5 w-full primary-button font-bold">
                                    {{ __('Sign up') }}
                                </button>
                            </td>
                        </tr>
