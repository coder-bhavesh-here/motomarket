    ...
    <div class="bg-white rounded-lg py-4 px-2 wommd:p-8 womsm:max-w-[80%] wommd:max-w-[75%] womsm:mx-auto womsm:mt-20 relative" style="box-shadow: 0 0 10px 0px gray;">
        ...
        <div class="w-full justify-items-center">
            ...
            <div class="w-4/5 wommd:w-3/4">
                <a href="{{ asset('docs/terms-conditions.pdf') }}" class="text-green underline text-xs womsm:text-sm wommd:text-base">Read the full terms here</a>
            </div>
                    ...
                    <div class="flex items-center">
                        <div class="w-full">
                            ...
                            <div class="items-center">
                                <x-text-input id="name" placeholder="Please provide your formal full name" :value="{{auth()->user()->name." ".auth()->user()->last_name}}"/>
                            </div>
                        </div>
                    </div>
                </div>
