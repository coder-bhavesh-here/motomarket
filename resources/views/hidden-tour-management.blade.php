...
<main class="mt-2 px-6">
    ...
    <div class="flex mt-8 mb-14">
        ...
        <a href="/hidden-tour-management"><span class="cursor-pointer text-center ml-4 active-management-option bg-gray management-option px-6 py-2">Hidden</span></a>
    ...
    <div class="w-full">
        ...
        <div class="bg-gray text-white text-center text-xl font-bold py-4">
            <span class="text-lg uppercase">Hidden</span>
        </div>
    </div>
