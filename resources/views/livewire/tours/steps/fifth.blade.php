        ...
        <div id="addonGroupsWrapper" class="space-y-10">
            {{-- <div class="p-6 rounded bg-[#F1F5F9] border relative addon-group" data-group-index="0">
                ...
                <div class="flex gap-4 mb-6 justify-center">
                    <label><input type="checkbox" name="groups[0][is_required]" /> Customer must select an add-on in this group</label>
                    <label><input type="checkbox" name="groups[0][is_multiple]" /> Customer can select multiple add-ons in this group</label>
                </div>
                    ...
                    <div class="flex items-center gap-4">
                        ...
                        <div class="flex flex-col items-center gap-1">
                            <div class="w-24 h-24 relative group border border-black border-dashed rounded flex items-center justify-center bg-gray-100 cursor-pointer overflow-hidden hover:bg-gray-200 transition dropzone">
                                <input type="file" accept="image/*" class="absolute inset-0 opacity-0 z-10 cursor-pointer file-input" name="groups[0][addons][0][image]" />
                        ...
                        <div class="w-full space-y-2">
                            <input type="text" name="groups[0][addons][0][name]" class="w-full border rounded p-2" placeholder="e.g. Riding with a passenger..." required />
                            <div class="flex items-center">
                                <span class="inline-block p-2 mr-2 bg-gray-200 rounded">{{$symbol}}</span>
                                <input type="number" step="0.01" name="groups[0][addons][0][price]" class="form-control w-full border rounded p-2" placeholder="123" required />
                            </div>
                        </div>
                    </div>
                </div>
