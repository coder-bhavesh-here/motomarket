    ...
    <div>
        <div class="my-10 sm:px-6 lg:px-8">
            <div class="flex items-center">
                ...
                <div class="w-5/6">
                    <x-input placeholder="Thrilling road trip to Faro, Algarve" value="{{ $tour->title }}"
                        name="title" />
                </div>
            </div>
        </div>
                ...
                <div class="w-5/6">
                    <div class="mb-6">
                        <x-radio id="road_trip" lg value="Road Trip"
                            label="Road Trip - Adventure on the road; its a road trip" :checked="$tour->riding_style == 'Road Trip'"
                            name="riding_style" />
                    </div>
                    <div class="mb-6">
                        <x-radio id="adventure" lg value="Adventure" label="Adventure - Adventure ride on and off road"
                            :checked="$tour->riding_style == 'Adventure'" name="riding_style" />
                    </div>
                    <div class="mb-3">
                        <x-radio id="enduro" lg value="Enduro" label="Enduro - Almost all of the trip is off road"
                            :checked="$tour->riding_style == 'Enduro'" name="riding_style" />
                    </div>
            ...
            <div class="flex items-center">
                ...
                <div class="w-5/6">
                    <x-input placeholder="Mainly off road 90% fire roads 10% harder tracks"
                        value="{{ $tour->riding_style_info }}" name="riding_style_info" />
                ...
                <div class="w-5/6">
                    <div class="mb-6">
                        <x-checkbox id="beginner" lg
                            ...
                            :checked="in_array('Beginner', explode(',', $tour->rider_capability ?? ''))" value="Beginner" name="rider_capability[]" />
                    </div>
                    <div class="mb-6">
                        <x-checkbox id="intermediate" lg
                            label="Intermediate - Capable most of the time, but might need help when things are difficult"
                            :checked="in_array('Intermediate', explode(',', $tour->rider_capability ?? ''))" value="Intermediate" name="rider_capability[]" />
                    </div>
                    <div class="mb-3">
                        <x-checkbox id="expert" lg label="Expert - Can help other riders and always in control"
                            :checked="in_array('Expert', explode(',', $tour->rider_capability ?? ''))" value="Expert" name="rider_capability[]" />
                    </div>
                    <div class="text-sm text-gray-500">
        ...
        <div class="my-10 sm:px-6 lg:px-8">
            <div class="flex items-center">
                ...
                <div class="w-5/6">
                    <x-input placeholder="Mainly off road 90% fire roads 10% harder tracks"
                        value="{{ $tour->rider_capability_info }}" name="rider_capability_info" />
                    <div class="text-sm text-gray-500 mt-2">
            ...
            <div class="flex items-center">
                ...
                <div class="w-3/6">
                    <div class="w-2/6 flex items-center">
                        <div><x-input name="duration_days" value="{{ $tour->duration_days }}" /></div>
        ...
        <div class="my-10 sm:px-6 lg:px-8">
            <div class="flex items-center">
                ...
                <div class="w-3/6">
                    <div class="w-2/6 flex items-center">
                        <div><x-input name="rest_days" value="{{ $tour->rest_days }}" /></div>
                        <div class="ml-2"><span>days</span></div>
                    </div>
                    <div class="text-sm text-gray-500 mt-2">
        ...
        <div class="my-10 sm:px-6 lg:px-8">
            <div class="flex items-center">
                ...
                <div class="w-3/6">
                    <div class="w-2/6">
                        <x-input name="max_riders" value="{{ $tour->max_riders }}" />
                    </div>
                    <div class="text-sm text-gray-500 mt-2">
        ...
        <div class="my-10 sm:px-6 lg:px-8">
            <div class="flex items-center">
                ...
                <div class="w-3/6">
                    <div class="w-2/6">
                        <x-input name="guides" value="{{ $tour->guides }}" />
                    </div>
                    <div class="text-sm text-gray-500 mt-2">
                ...
                <div class="w-5/6">
                    <div class="mb-6">
                        <x-radio id="included" lg
                            ...
                            :checked="$tour->bike_option == 'Bike included'" value="Bike included" name="bike_option" />
                    </div>
                    <div class="mb-6">
                        <x-radio id="own_bike" lg
                            label="Bring their own bike - It is mandatory to bring the bike, rental is not available"
                            :checked="$tour->bike_option == 'Bring own bike'" value="Bring own bike" name="bike_option" />
                    </div>
                    <div class="mb-3">
                        <x-radio id="both" lg
                            label="Bike can be rented or bring your own bike - The rider can rent or bring their own"
                            :checked="$tour->bike_option == 'Bike rental'" value="Bike rental" name="bike_option" />
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="w-5/6">
                    <div class="mb-6">
                        <x-radio id="from-us" value="1" lg label="The rider can rent gear from us"
                            :checked="$tour->rent_gear == '1'" name="rent_gear" />
                    </div>
                    <div class="mb-3">
                        <x-radio id="own-gear" value="0" lg label="Bring your own riding gear"
                            :checked="$tour->rent_gear == '0'" name="rent_gear" />
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="w-5/6">
                    <div class="mb-6">
                        <x-radio id="no" lg
                            ...
                            :checked="$tour->two_up_riding == '0'" name="two_up_riding" />
                    </div>
                    <div class="mb-3">
                        <x-radio id="yes" lg
                            label="Yes - This tour can be done with 2 people on the bike. The rider and a passenger"
                            :checked="$tour->two_up_riding == '1'" value="1" name="two_up_riding" />
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="my-10 sm:px-6 lg:px-8">
            <div class="flex items-center">
                ...
                <div class="w-3/6">
                    <div class="w-2/6 flex items-center">
                        <div><x-input name="tour_distance" value="{{ $tour->tour_distance }}" /></div>
            ...
            <div class="flex items-center">
                ...
                <div class="w-5/6">
                    <div class="items-center">
                        @php
                            $countries = explode(',', $tour->countries);
                        @endphp
