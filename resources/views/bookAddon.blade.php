    ...
    $(document).ready(function() {
        ...
        function calculateTotalPrice() {
            ...
            $(".addon-checkbox:checked").each(function() {
                ...
                $("#addonsShow").append("<div class='w-full mt-4 inline-flex justify-between'><span class='w-full max-w-64 womsm:max-w-none womsm:w-auto'>"+ tempName +"</span><span>" + currencySymbol + " " + tempPrice +"</span></div>");
