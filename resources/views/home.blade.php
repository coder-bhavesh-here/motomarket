...
<div>
    <div class="grid grid-cols-1 wommd:grid-cols-2 mt-5 max-w-7xl mx-5 py-8 gap-8 justify-self-center">
        <div class="bg-[#E2E8F0] p-5 rounded-md" onclick="window.location.href='/about-worldonmoto';">
            <a href="/about-worldonmoto"><p class="text-xl womsm:text-2xl font-semibold m-2 text-[#0F172A]">About WorldonMoto.com</p></a>
            ...
            <a href="/about-worldonmoto"><button class="secondary-button mt-2">read more</button></a>
        </div>
    ...
    <div
        ...
        onclick="window.location.href='/invite-tour-operators';">
        <a href="/invite-tour-operators"><p class="font-semibold m-2 text-xl womsm:text-2xl text-[#0F172A]">Do you organise motorbike tours?</p></a>
        <p class="text-xs womsm:text-xl m-2 wommd:py-5 wommd:px-10 text-[#0F172A]">We are inviting motorcycle adventure
            ...
            <a href="/invite-tour-operators"><button class="secondary-button mt-2">find out more</button></a>
    </div>
</div>
